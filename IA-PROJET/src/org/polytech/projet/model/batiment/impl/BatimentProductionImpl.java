...
import org.polytech.projet.model.batiment.BatimentProduction;
 ...
 * <ul>
 *   <li>{@link org.polytech.projet.model.batiment.impl.BatimentProductionImpl#getNom <em>Nom</em>}</li>
 *   <li>{@link org.polytech.projet.model.batiment.impl.BatimentProductionImpl#getLevelBatiment <em>Level Batiment</em>}</li>
 *   <li>{@link org.polytech.projet.model.batiment.impl.BatimentProductionImpl#getCoordonneeBatiment <em>Coordonnee Batiment</em>}</li>
 *   <li>{@link org.polytech.projet.model.batiment.impl.BatimentProductionImpl#getSymbole <em>Symbole</em>}</li>
 *   <li>{@link org.polytech.projet.model.batiment.impl.BatimentProductionImpl#getListUnit <em>List Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BatimentProductionImpl extends EObjectImpl implements BatimentProduction {
	/**
	 ...
	 * @generated
	 */
	protected BatimentProductionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BatimentPackage.Literals.BATIMENT_PRODUCTION;
	}
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BatimentPackage.BATIMENT_PRODUCTION__NOM, oldNom, nom));
	}
	...
	public void setLevelBatiment(int newLevelBatiment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BatimentPackage.BATIMENT_PRODUCTION__LEVEL_BATIMENT, oldLevelBatiment, levelBatiment));
	}
	...
	public Coordonnee getCoordonneeBatiment() {
		if (coordonneeBatiment != null && coordonneeBatiment.eIsProxy()) {
			...
			if (coordonneeBatiment != oldCoordonneeBatiment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BatimentPackage.BATIMENT_PRODUCTION__COORDONNEE_BATIMENT, oldCoordonneeBatiment, coordonneeBatiment));
			}
		}
	...
	public void setCoordonneeBatiment(Coordonnee newCoordonneeBatiment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BatimentPackage.BATIMENT_PRODUCTION__COORDONNEE_BATIMENT, oldCoordonneeBatiment, coordonneeBatiment));
	}
	...
	public void setSymbole(char newSymbole) {
		...
		symbole = newSymbole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BatimentPackage.BATIMENT_PRODUCTION__SYMBOLE, oldSymbole, symbole));
	}
	...
	public EList<Unite> getListUnit() {
		if (listUnit == null) {
			listUnit = new EObjectResolvingEList<Unite>(Unite.class, this, BatimentPackage.BATIMENT_PRODUCTION__LIST_UNIT);
		}
		return listUnit;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BatimentPackage.BATIMENT_PRODUCTION__NOM:
				return getNom();
			case BatimentPackage.BATIMENT_PRODUCTION__LEVEL_BATIMENT:
				return getLevelBatiment();
			case BatimentPackage.BATIMENT_PRODUCTION__COORDONNEE_BATIMENT:
				if (resolve) return getCoordonneeBatiment();
				return basicGetCoordonneeBatiment();
			case BatimentPackage.BATIMENT_PRODUCTION__SYMBOLE:
				return getSymbole();
			case BatimentPackage.BATIMENT_PRODUCTION__LIST_UNIT:
				return getListUnit();
		}
