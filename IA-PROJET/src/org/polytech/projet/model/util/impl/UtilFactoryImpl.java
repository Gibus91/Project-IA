/**
 */
package org.polytech.projet.model.util.impl;
...
public class UtilFactoryImpl extends EFactoryImpl implements UtilFactory {
	...
	public static UtilFactory init() {
		try {
			UtilFactory theUtilFactory = (UtilFactory)EPackage.Registry.INSTANCE.getEFactory("org.polytech.projet.model.util"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case UtilPackage.COORDONNEE: return createCoordonnee();
			default:
